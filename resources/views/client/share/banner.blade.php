<section class="banner-area banner-bg" data-background="/client_assets/img/banner/banner_bg01.png">
    <div class="container custom-container">
        <div class="row">
            <div class="col-xl-6 col-lg-8">
                <div class="banner-content">
                    <h6 class="sub-title wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1.8s">Movflx
                    </h6>
