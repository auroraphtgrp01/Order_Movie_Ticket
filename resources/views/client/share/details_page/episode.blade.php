<section class="episode-area episode-bg" data-background="/client_assets/img/bg/episode_bg.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                                    ...
                                    <div class="card-body">
                                        <ul>
                                            <li><a href="https://www.youtube.com/watch?v=R2gbPxeNk2E"
                                                    ...
                                                    - The World Is Purple</a> <span class="duration"><i
                                            ...
                                            <li><a href="https://www.youtube.com/watch?v=R2gbPxeNk2E"
                                                    ...
                                                    - Meaner Than Evil</a> <span class="duration"><i
                                                        class="far fa-clock"></i> 28 Min</span></li>
                                            <li><a href="https://www.youtube.com/watch?v=R2gbPxeNk2E"
                                                    class="popup-video"><i class="fas fa-play"></i> Episode 3
                                                    - I Killed a Man Today</a> <span class="duration"><i
                                                        class="far fa-clock"></i> 28 Min</span></li>
                                            <li><a href="https://www.youtube.com/watch?v=R2gbPxeNk2E"
            ...
            <div class="col-lg-4">
                <div class="episode-img">
                    <img src="/client_assets/img/images/episode_img.jpg" alt="">
                </div>
            </div>
        </div>
        <div class="row">
