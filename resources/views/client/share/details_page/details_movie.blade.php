<div class="modal fade mt-5 xs" style="" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><b class="text-danger">LỊCH CHIẾU</b></h5>
...
<div class="modal fade mt-5 xs" style="" id="veModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">LỊCH CHIẾU CỦA: <b
                        class="text-danger">@{{ tt_lich.ngay_chieu }}</b> - <b
                        class="text-success">@{{ tt_lich.gio_chieu }}</b></h5>
                <button type="button" class="btn-close" data-bs-toggle="modal" data-bs-target="#editModal"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="100%" class="bg-warning text-center align-middle">
                                                <h5 class=" text-danger"><b>MÀN CHIẾU</b></h5>
                                            </th>
                                        </tr>
                ...
                <div class="movie-details-content">
                    ...
                    <div class="banner-meta">
                        <ul>
                            ...
                            <li class="category">
                                <b class="text-warning">@{{ dataMovie.the_loai }}</b>
                            </li>
                    ...
                    <div class="movie-details-prime">
                        <ul style="max-width: 550px;">
                            ...
                            <li class="btn btn-danger">
                                <button href="" class="btn popup-video" data-bs-toggle="modal"
                            ...
                            <li class="btn btn-success ms-4"><a v-bind:href="dataMovie.trailer"
