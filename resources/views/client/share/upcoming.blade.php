                ...
                <div class="ucm-active owl-carousel">
                        ...
                        <div class="movie-item mb-50">
                            <div class="movie-poster">
                                <a href="movie-details.html"><img class="img-thumbnail"
                                        style="width: 300px; height: 400px;" src="@{{ $value - > hinh_anh }}"
                                        alt=""></a>
                            </div>
                            <div class="movie-content">
                                <div class="top">
                                    <h5 class="title"><a href="movie-details.html">{{ $value->ten_phim }}</a></h5>
                    ...
                    <template v-for="(v, k) in list_Movie">
                        <div class="movie-item mb-50">
                            <div class="movie-poster">
                                <a href="movie-details.html"><img class="img-thumbnail"
                                        style="width: 300px; height: 400px;" v-bind:src="v.hinh_anh" alt=""></a>
                            </div>
                            <div class="movie-content">
                                <div class="top">
