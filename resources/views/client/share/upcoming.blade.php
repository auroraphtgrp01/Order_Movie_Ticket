<section class="ucm-area ucm-bg"
    data-background="/client_assets/img/bg/ucm_bg.png">
    <div class="container">
                ...
                <div class="ucm-nav-wrap">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="tvShow-tab"
                                data-toggle="tab" href="#tvShow" role="tab"
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="tvShow" role="Ftabpanel"
                ...
                <div class="ucm-active owl-carousel">
                    ...
                    <div class="movie-item mb-50">
                        ...
                        <div class="movie-content">
                            <div class="top">
                                <h5 class="title"><a
                                        href="/movie-detail/{{ $value->slug_phim }}">{{
                                        $value->ten_phim }}</a>
                                </h5>
