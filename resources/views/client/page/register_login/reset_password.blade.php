...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Đặt lại mật khẩu - Auroraphtgrp Cinema</title>
    ...
    <body>
        ...
        <main id="resetPassword" class="main__content_wrapper">
                            ...
                            <div class="col-md-8">
                                <div class="account__login">
                                    <div class="account__login--header mb-25">
                                        <h2
                                            class="account__login--header__title mb-10">Đổi
                                            Mật Khẩu</h2>
        ...
        <script src="/JS_Client/changePassword.js"></script>
