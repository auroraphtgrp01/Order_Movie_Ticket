                        ...
                        <div class="col">
                            <div class="account__login">
                                <div class="account__login--header mb-25">
                                    ...
                                    <p class="account__login--header__desc">Nhập vào email đăng nhập để lấy lại mật khẩu
                                    </p>
                                </div>
                                <div class="account__login--inner">
                                    <label>
                                        <input v-model="info.email" class="account__login--input"
                                            placeholder="Nhập vào email" type="email">
                                    </label>
                                    <div class="d-grid gap-2 col-6 mx-auto">
                                        <button v-on:click="resetPassword()" class="account__login--btn primary__btn"
    ...
    <script>
        new Vue({
                    ...
                    methods: {
                        resetPassword() {
                            axios
                                .post('{{ Route('resetPassword') }}', this.info)
                                .then((res) => {
                                        if (res.data.status) {
                                            ...
                                            content = "Morden Bootstrap HTML5 Template" >
                                                <
                                                meta name = "viewport"
                                            ...
                                            href = "/asstes_client_login_regis/css/plugins/glightbox.min.css" >
                                                ...
                                                link
                                            href =
                                                "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700&family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500&display=swap"
                                            rel = "stylesheet" >
                                                <
                                                !--Plugin css-- >
                                                <
                                            ...
                                            href = "/asstes_client_login_regis/css/vendor/bootstrap.min.css" >
                                                ...
                                                <
                                                link rel = "stylesheet"
                                            href = "/asstes_client_login_regis/css/style.css" >
                                                <
                                                link rel = "stylesheet"
                                            href = "https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css"
                                            integrity =
                                                "sha512-3pIirOrwegjM6erE5gPSwkUzO+3cTjpnV9lexlNZqvupR64iZBnOOTiiLPb9M36zpMScbmUNIcHUqKD47M719g=="
                        ...
                        <div class="row row-cols-md-1 row-cols-1">
                            <div class="col">
                                <div class="account__login">
                                    ...
                                    <div class="account__login--inner">
                                        <label>
                                            <input v-model="info.password" class="account__login--input"
                                                placeholder="Nhập vào mật khẩu" type="password">
                                            <input id="id" hidden class="account__login--input"
                                                value="{{ $id }}">
                                        </label>
                                        <label>
                                        ...
                                        <div class="d-grid gap-2 col-6 mx-auto">
                                            <button v-on:click="doiMK()" class="account__login--btn primary__btn"
                                                type="button">Đổi Mật
                                                Khẩu</button>
                                        </div>
                                        <div class="account__login--divide">
            ...
            new Vue({
                ...
                methods: {
                    doiMK() {
                        this.info.id = $("#id").val();
                        axios
                            .post('{{ Route('doimatkhau') }}', this.info)
                            .then((res) => {
