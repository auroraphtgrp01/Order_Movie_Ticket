    ...
    <nav class="navbar navbar-expand-xl w-100">
        <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
            <li class="nav-item dropdown">
                <a href="/admin/phim" class="nav-link dropdown-toggle dropdown-toggle-nocaret">
            ...
            <li class="nav-item dropdown">
                <a href="/admin/phong-chieu" class="nav-link dropdown-toggle dropdown-toggle-nocaret">
            ...
            <li class="nav-item dropdown">
                <a href="/admin/danh-sach-account" class="nav-link dropdown-toggle dropdown-toggle-nocaret">
            ...
            <li class="nav-item dropdown">
                <a href="/admin" class="nav-link dropdown-toggle dropdown-toggle-nocaret">
            ...
            <li class="nav-item dropdown">
                <a href="/admin/don-vi" class="nav-link dropdown-toggle dropdown-toggle-nocaret">
            ...
            <li class="nav-item dropdown">
                <a href="/admin/dich-vu" class="nav-link dropdown-toggle dropdown-toggle-nocaret">
            ...
            <li class="nav-item dropdown">
                <a href="/admin/lich-chieu" class="nav-link dropdown-toggle dropdown-toggle-nocaret">
            ...
            <li class="nav-item dropdown">
                <a href="/admin/ghe-chieu/1" class="nav-link dropdown-toggle dropdown-toggle-nocaret">
